...
function deleteEntity() {
  ...
  ajax.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      ...
      console.log(data);
      if (onArtistView) {
        memberContainer.innerHTML = "<h2>" + data.name
            + " has been deleted</h2><p>All of his/her albums and tracks have been removed from our website.</p>";
      } else {
        memberContainer.innerHTML = "<h2>" + data.name
            + " has been deleted</h2><p>All tracks contained within the album has been removed.</p>";
      }
    }
  };
...
function createArtist() {
  var artist = {
    "entityName": inputArtistName.value,

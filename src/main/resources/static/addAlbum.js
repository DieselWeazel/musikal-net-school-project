...
function postAlbum() {
  ...
  var album = {
    "entityName": albumNameInput.value, "description": descriptionInput.value,
...
function main() {
  ...
  addTrackButton.addEventListener("click", function () {
    ...
    td.innerHTML = "<tr><td>" +
        ...
        "<input type='text' name='track' id='inputTrack" + trackCounter
        + "' value='TRACK NAME' class='inputTrackClass'></td></tr>";

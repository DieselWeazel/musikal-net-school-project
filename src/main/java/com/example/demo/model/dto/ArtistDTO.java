...
public class ArtistDTO extends EntityDTO {
    ...
    public ArtistDTO(String entityName, String description, Long artistId, SimpleGenreDTO genre, String image) {
    ...
    public ArtistDTO(String entityName, String description, Long artistId, List<SimpleAlbumDTO> albumList, SimpleGenreDTO genre, String image) {
        super(entityName, description);
        this.artistId = artistId;

...
public class MusikalnetApplication {
  ...
  //  @Bean
  //  public CommandLineRunner commandLineRunner(AbstractMusicService<Artist, ArtistDTO>
  // artistService,
  ...
  //
  //
  //      List<Album> albumFilterList =
  // albumRepository.findByEntityTitleContainingIgnoreCase("Maniac");
  //      albumFilterList.forEach(e-> System.out.println("filter result: " + e.getEntityTitle()));
  //
  //      List<Artist> artistFilterList =
  // artistRepository.findByEntityTitleContainingIgnoreCase("Pa");
  //      artistFilterList.forEach(e-> System.out.println("Filtered artist res: " +
  // e.getEntityTitle()));
  //
  //      List<Track> trackFilterList =
  // trackRepository.findByEntityTitleContainingIgnoreCase("Hardcore");
  //
  //      trackFilterList.forEach(e-> System.out.println("Filter tracks: " + e.getEntityTitle() + "
  // by: " + e.getArtist().getEntityTitle()));
  //    };
  //  }
  //  @Bean
  ...
  //  }
  @Bean
  public CommandLineRunner cmdRunnerTestService2(
      AbstractMusicService<Album, AlbumDTO, AlbumCreateDTO> albumServiceImpl) {
    return args -> {
      ...
      fiterGenre.forEach(
          e -> System.out.println("FILTER SERVICE IMPL(frenchcore): " + e.getName()));
    };
  }
}

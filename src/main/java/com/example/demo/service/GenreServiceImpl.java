...
public class GenreServiceImpl implements AbstractMusicService<Genre, GenreDTO, SimpleGenreDTO> {
  ...
  public GenreServiceImpl(
      ...
      LoadChildEntities<Genre, SimpleArtistOnlyDTO> loadGenreTracksFromArtist,
      LoadChildEntities<Genre, SimpleAlbumOnlyDTO> loadGenreTracksFromAlbum,
      LoadChildEntities<Genre, SimpleTrackDTO> loadTracksFromGenre) {
  ...
  public List<GenreDTO> loadAll() {
    return genreRepository.findAll().stream()
        .map(
            genre ->
                new GenreDTO(
                    genre.getEntityTitle(),
                    genre.getDescription(),
                    loadGenreTracksFromArtist.loadAllChildEntities(genre),
                    loadGenreTracksFromAlbum.loadAllChildEntities(genre),
